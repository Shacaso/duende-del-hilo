import { Bill, Client, Departament } from "@/app/lib/definitions";
...
export default function Form({ data }: Props) {
  ...
  const idClients = clients.map((client) => client.id);
  ...
  const billSchema = z.object({
    ...
    idUser: z.string().refine((value) => idClients.includes(value), {
